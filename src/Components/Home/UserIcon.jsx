...
const UserIcon = () => {
  return (
    <div className="mx-20 my-24">
      <h2 className="mx-20 mt-10 text-center text-orange-400 text-4xl font-bold">
        Join over 2,000 teams worldwide that are using{" "}
        <span className="text-blue">Pro-track</span> to get more done.
      </h2>
