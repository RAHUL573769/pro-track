...
const UserIcon = () => {
  return (
    ...
    <div className="hero">
      <div className='hero-content flex-col lg:flex-row-reverse bg-background lg:py-32 lg:mt-8 lg:mx-16 rounded-3xl'>
        ...
        <div className="">
          <h2 className='lg:mx-20 mt-2 text-center text-paragraph text-2xl lg:text-4xl font-bold'>Connect to <span className='text-header font-extrabold'>Pro-Track</span> with your preferred apps</h2>
        </div>
      </div>
