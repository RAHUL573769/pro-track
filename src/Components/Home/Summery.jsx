...
=======
    <>
      <div className="-mt-20">
        <div className=" flex-col lg:flex-row-reverse bg-[#F9ECD9] lg:py-48 lg:my-24 lg:mx-16   rounded-3xl">
          <h2 className="text-5xl font-bold text-center -mt-24 ">
            Main work summery of <span className="text-blue">Pro-Track</span>
          </h2>
        </div>
        ...
        <div className="card max-w-lg bg-[#eaf2d7] -mt-72 shadow-xl transform transition duration-500 hover:scale-110">
          ...
          <div className="card-body items-center text-center">
            ...
            <p className="text-2xl">
              Pro-Track will Track the issue first and make decision for each
              part of the issue and provide a system to meetup the solution.
            </p>
        ...
        <div className="card max-w-lg bg-[#f6efe9] -mt-72  shadow-xl transform transition duration-500 hover:scale-110">
          ...
          <div className="card-body items-center text-center">
            <h2 className="text-3xl font-bold">
              Set the path to solve the issue
            </h2>
            <img
              style={{ height: "320px" }}
              src={solve}
            ...
            />
            <p className="text-2xl">
              pro-track is the pro-solver of your each issue .after track the
              issue and finalize each step Pro-Track is going to be solve the
              issue of User.
            </p>
            <div className="card-actions"></div>
          </div>
