        ...
        <div>
          <ul class="flex items-center">
            ...
            <li>
              <button
                aria-label="chat"
                class="w-8 h-8 mr-3 rounded-xl  focus:bg-gray-100 active:bg-gray-200"
              >
                <div className="indicator">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 m-auto text-gray-600"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <span class="badge badge-xs bg-rose-700 indicator-item">
                    3
                  </span>
                </div>
              </button>
