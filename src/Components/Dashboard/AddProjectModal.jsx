...
// <div>
//     <label for="create-project" className="btn btn-success font-bold"><GrAdd className="mr-2"></GrAdd>Create Project</label>
//     <input type="checkbox" id="create-project" className="modal-toggle " />
//     <div className="modal lg:ml-60 mt-10 overflow-hidden">
//         <div className="modal-box max-w-lg w-11/12 lg:max-w-5xl">
//             <h3 className="font-bold text-lg">Hello user! Create Your project here.</h3>
//             <form onSubmit={handleSubmit(onSubmit)}>
...
//                 </div>
//                 <div className="modal-action flex justify-between">
//                     <label for="create-project" className="btn">Cancel</label>
